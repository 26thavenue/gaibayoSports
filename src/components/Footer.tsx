...
const Footer = () => {
  return (
    <div className="bg-[#4B86C5] py-8 my-12 px-12 w-full">
      <div className="text-white w-full px-8 rounded-md py-12">
        {/* Logo and Title */}
        <div className="flex flex-col gap-2 items-center mb-8">
          <img
            src="/GAIBAYO_SPORT_LOGO__NEW__page-0001__1_-removebg-preview.png"
            alt="logo"
            className="h-[200px] w-[200px] object-cover bg-white rounded-[50%] p-4"
          />
          {/* <h1 className="text-2xl font-semibold">Gaibayo Sports</h1> */}
           <div className="flex l gap-6 text-lg my-6">
